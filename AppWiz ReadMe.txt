...
ConStationDoc.h, ConStationDoc.cpp - the document
    These files contain your CConStationDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CConStationDoc::Serialize).

ConStationView.h, ConStationView.cpp - the view of the document
    These files contain your CConStationView class.
    CConStationView objects are used to view CConStationDoc objects.
